            ...
            <div class="ms-lg-3 d-none d-md-none d-lg-block">
                ...
                <form class="d-flex align-items-center">
                    <div class="input-group">
                        <!-- Input -->
                        <input type="search" name="search" id="textInput" class="form-control"
                            aria-label="Search here" aria-describedby="button-addon2" placeholder="Search for a member"
                            value="">
                        <div class="input-group-append">
                            <button class="btn btn-primary rounded-0 rounded-end" type="submit"
                                id="button-addon2"> <i data-feather="search"></i></button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <li class="dropdown ms-2">
                    <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown"
                        ...
                        <div class="avatar avatar-md avatar-indicators avatar-online">
                            <img alt="avatar" src="{{ asset('assets/images/uploads/avatar-1.jpg') }}"
